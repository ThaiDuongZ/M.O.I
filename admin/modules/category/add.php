...
?>
<form method="POST" action="modules/category/edit.php">
    <div class="add__gird">
        ...
        <div class="add_wrap">
            <div class="add_wrap0">
                ...
                <div class="add__name">
                    ...
                    <textarea name="Ten_dm" id="" cols="50" rows="3" class="add__name--code"></textarea>
                    <!-- <input type="text" class="add__name--code" name="Ten_dm"> -->
                </div>
                <div class="add__name">
                    <div class="add__name--name">Nhóm danh mục</div>
                    <input type="text" class="add__name--code add__name--code10" name="Ma_nh">
                </div>
                <div class="add__name">
                    <div class="add__name--name">Acitve</div>
                    <select name="Active" id="" class="form-select form-select0" style="width: 163px">
