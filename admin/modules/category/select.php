...
?>
<form method="GET" action="modules/category/edit.php">
    <div class="add__gird">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td><a href="modules/category/edit.php?query=delete&id=<?php echo $row['Ma_dm']?>">Xóa danh mục</a> | <a href="index.php?admin=category&query=update&id=<?php echo $row['Ma_dm']?>">Sửa danh mục</a></td>
                </tr>
