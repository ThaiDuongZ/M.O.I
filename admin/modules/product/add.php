        ...
        <div class="add_wrap__sp">
            <div class="add_wrap__sp0">
                ...
                <div class="add__name">
                    ...
                    <input type="text" class="add__name--code1" name="Gia_sp">
                </div>
                <div class="add__name">
                    <div class="add__name--name">Hình ảnh</div>
                    <input type="file" class="add__name--code3" name="Img_sp">
                </div>
                <div class="add__name">
                    <div class="add__name--name">Nhóm sản phẩm</div>
                    <input type="text" class="add__name--code2" name="Ma_nh_sp">
                </div>
                <div class="add__name">
                    <div class="add__name--name">Nhóm danh mục</div>
                    <!-- <input type="text" class="add__name--code" name="Ma_dm"> -->
                    <select name="Ma_dm" id="" class="form-select form-select1" style="width: 200px">
                    <?php
                ...
                <div class="add__name">
                    ...
                    <select name="Active" id="" class="form-select form-select2" style="width: 200px">
            ...
            <div class="add_wrap__sp1">
                ...
                <div class="add__name">
                    ...
                    <textarea name="Dien_giai" id="" cols="50" rows="7" class="add__name--code5"></textarea>
                </div>
            </div>
        </div>
    </div>
